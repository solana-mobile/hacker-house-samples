...
object GetLatestBlockhashUseCase {
    ...
    suspend operator fun invoke(
        ...
        return withContext(Dispatchers.IO) {
            ...
            conn.outputStream.use { outputStream ->
                outputStream.write(createGetLatestBlockhashRequest(commitment).encodeToByteArray())
            }
            conn.connect()
            ...
            val (blockhashBase58, minContextSlot) = conn.inputStream.use { inputStream ->
                ...
                parseGetLatestBlockhashResponse(response)
            }
    ...
    private fun createGetLatestBlockhashRequest(commitment: Commitment): String {
        val jo = JSONObject()
        jo.put("jsonrpc", "2.0")
        jo.put("id", 1)
    ...
    private fun parseGetLatestBlockhashResponse(response: String): Pair<String, Int> {
